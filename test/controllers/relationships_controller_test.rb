...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { followed_user_id: @relationship.followed_user_id, following_user_id: @relationship.following_user_id }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { followed_user_id: @relationship.followed_user_id, following_user_id: @relationship.following_user_id }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
